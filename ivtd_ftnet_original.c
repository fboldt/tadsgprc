...
/* Iterative Virtual Topology Design para Minimizacao do Processamento Eletronico */
int ivtd_ftnet_original(char *modelo, char *dados)
{
...
int main(int argc, char **argv)
{
	...
	result = ivtd_ftnet_original(nomeArqModelo, nomeArqDados);
