...
/* Iterative Virtual Topology Design para Processamento Eletronico de Trafego */
int ivtd_ftnet_esp(char *modelo, char *modeloEsp, char *dados)
{
	...
	while(!sair)
	{
		...
		milpAtribuiTopologiaBijLP(lpEsp, topologia);

		//printf("resolve lp\n");
		valor = gwResolveLP(lp); // variavel valor armazena funcao objetivo otimizada
		//printf("Processamento da Topologia = %lf\n", valor);
...
int main(int argc, char **argv)
{
	...
	result = ivtd_ftnet_esp(nomeArqModelo, nomeArqmodeloEsp, nomeArqDados);
